...
class TestYuihuang():
  ...
  def test_yuihuang(self):
    ...
    for i in range(1,num_of_apcs_question+2):
        # 4 | storeWindowHandle | root | 
        self.driver.find_element(By.XPATH, "//article[@id=\'post-13513\']/div/figure[2]/table/tbody/tr["+str(i)+"]/td[5]/a").click()
        # 強制等待1秒
        time.sleep(1)
